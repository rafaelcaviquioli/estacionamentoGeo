...
(function (e) {
    if (e.fn.ajaxForm == undefined) {
        e.getScript("bootstrap/dist/js/jquery.form.js")
    }
    var t = {};
    ...
    e.fn.uploadFile = function (n) {
        ...
        function f(t, n, r) {
            r.on("dragenter", function (t) {
                t.stopPropagation();
                t.preventDefault();
                e(this).css("border", "1px solid #ddd")
            });
        ...
        function h(t, n, r) {
            for (var i = 0; i < r.length; i++) {
                ...
                var d = new g(n, t);
                var v = "";
                if (t.showFileCounter)v = n.fileCounter + t.fileCounterStyle + r[i].name; else v = r[i].name;
                d.filename.html(v);
            ...
            f.change(function () {
                ...
                if (t.fileapi && t.formdata) {
                    ...
                    for (var b = 0; b < a.length; b++) {
                        if (i.showFileCounter)d += n.fileCounter + i.fileCounterStyle + a[b] + "<br>"; else d += a[b] + "<br>";
                        n.fileCounter++
                    }
        ...
        function g(t, n) {
            this.statusbar = e("<div class='panel panel-default' style='margin-bottom: 0; padding: 10px;'></div>").width(n.statusBarWidth);
            ...
            this.progressbar = e("<div class='progress-bar progress-bar-success " + t.formGroup + "'  role=\"progressbar\" aria-valuenow=\"40\" aria-valuemin=\"0\" aria-valuemax=\"100\" style='height: 15px;'></div>").appendTo(this.progressDiv);
            this.abort = e("<div class='btn btn-danger ajax-file-upload-abort " + t.formGroup + "'>" + n.abortStr + "</div>").appendTo(this.statusbar).hide();
            this.cancel = e("<div class='btn btn-danger ajax-file-upload-cancel " + t.formGroup + "'>" + n.cancelStr + "</div>").appendTo(this.statusbar).hide();
            this.done = e("<div class='btn btn-success'>" + n.doneStr + "</div>").appendTo(this.statusbar).hide();
            this.download = e("<div class='btn btn-info'>" + n.downloadStr + "</div>").appendTo(this.statusbar).hide();
            this.del = e("<div class='btn btn-danger'>" + n.deletelStr + "</div>").appendTo(this.statusbar).hide();
            if (n.showQueueDiv)e("#" + n.showQueueDiv).append(this.statusbar); else t.errorLog.after(this.statusbar);
            return this
        }
        ...
        function y(n, r, i, s, o, u) {
            ...
            var l = {
                ...
                beforeSubmit: function (e, t, u) {
                        ...
                        if (f) {
                            ...
                            if (l) {
                                for (var h = 0; h < l.length; h++) {
                                    if (l[h]) {
                                        if (r.fileData != undefined)u.formData.append(l[h][0], l[h][1]); else u.data[l[h][0]] = l[h][1]
                                    }
                                }
                            }
                        }
                    ...
                    i.statusbar.append("<div class='alert alert-danger'>" + r.uploadErrorStr + "</div>");
                    i.cancel.show();
                    n.remove();
                ...
                success: function (t, u, a) {
                    if (r.returnType == "json" && e.type(t) == "object" && t.hasOwnProperty(r.customErrorKeyStr)) {
                        ...
                        if (r.showStatusAfterError) {
                            i.progressDiv.hide();
                            i.statusbar.append("<span class='alert-danger'>ERROR: " + f + "</span>")
                        } else {
                            i.statusbar.hide();
                            i.statusbar.remove()
                        }
                ...
                error: function (e, t, u) {
                    ...
                    if (e.statusText == "abort") {
                        ...
                        if (r.showStatusAfterError) {
                            i.progressDiv.hide();
                            i.statusbar.append("<span class='alert-danger'>ERROR: " + u + "</span>")
                        } else {
                            i.statusbar.hide();
                            i.statusbar.remove()
                        }
        ...
        var r = e.extend({
            ...
            extErrorStr: " extensão não permitido. Extensões permitidas: ",
        ...
        (function b() {
            if (e.fn.ajaxForm) {
                if (r.dragDrop) {
                    var t = e('<div class="panel panel-default" style="vertical-align:top; padding: 10px; margin-button: 0"></div>').width(r.dragdropWidth);
                    e(s).before(t);
                    e(t).append(o);
                    e(t).css(r.stylePanel);
