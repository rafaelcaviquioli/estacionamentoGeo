 ...
 * <pre>
 *  $handle = new UploadImagem($_FILES['image_field']);
 *  if ($handle->uploaded) {
 ...
 * <pre>
 *  $handle = new UploadImagem('/home/user/myfile.jpg');
 * </pre>
 *
 * <b>How to set the language?</b><br>
 * Instantiate the class with a second argument being the language code:
 * <pre>
 *  $handle = new UploadImagem($_FILES['image_field'], 'fr_FR');
 *  $handle = new UploadImagem('/home/user/myfile.jpg', 'fr_FR');
 * </pre>
 *
    ...
    function process($server_path = null) {
        ...
        if ($this->processed) {
            ...
            if ($this->file_safe_name) { // formats the name
                $this->file_dst_name_body = strtr($this->file_dst_name_body, '� ŽšžŸ�?Á�?�?�?�?�?�?�?�?�?�?Í�?Ï�?�?�?�?�?�?�?�?�?�?�?Ý� áâãäåçèéêëìíîïñòóôõöøùúûüýÿ', 'SZszYAAAAAACEEEEIIIINOOOOOOUUUUYaaaaaaceeeeiiiinoooooouuuuyy');
                $this->file_dst_name_body = strtr($this->file_dst_name_body, array('�?' => 'TH', 'þ' => 'th', 'Ð' => 'DH', 'ð' => 'dh', '�?' => 'ss', '�?' => 'OE', '�?' => 'oe', '�?' => 'AE', 'æ' => 'ae', 'µ' => 'u'));
